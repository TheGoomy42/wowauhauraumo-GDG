...
public class PartyMember {
	 ...
	 * 
	 * when levelling up, all of the stats below increase based on a multiplier contained in the Job
	 * and a random factor based on the multiplier.
	 * e.g. if the multiplier is 1.25, the randomly generated actual multiplier would be
	 *      1.25 + (random.nextDouble() - 0.5) <-- this is crap
	 */
	...
	public enum Job {
		...
		private Job(Sprite s, int levelMultiplier, int maxHPMultiplier, int currentHPMultiplier,
